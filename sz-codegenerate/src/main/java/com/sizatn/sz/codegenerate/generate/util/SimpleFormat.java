...
public class SimpleFormat {
	...
	public String getInStrs(List<String> params) {
		...
		for (Object object = (Object) params.iterator(); ((Iterator) object).hasNext();) {

			String str = ((Iterator<String>) object).next();
			localStringBuffer.append("'" + str + "',");
		}
		String localObject = localStringBuffer.toString();
		if (!"".equals(localObject) || localObject.endsWith(",")) {

			localObject = localObject.substring(0, localObject.length() - 1);
			return localObject;
		}
		return null;
	}
