...
public class ImageGeoUtil {
	...
	public ImageGeoUtil(String filename) {
		try {
			error = false;
	...
	public static void main(String[] args) {
		ImageGeoUtil imageGeo = new ImageGeoUtil(ImageGeoUtil.class.getResource("IMAG0068.jpg").getFile());
